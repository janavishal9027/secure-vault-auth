// Build pipeline for the Authentication service.
//
...
pipeline {
  ...
  environment {
    ...
    IMAGE_REPO  = 'kittuvittu/secure-vault-authentication'
...
the target env (e.g. image-versions/authentication-<env>_image.yaml):
